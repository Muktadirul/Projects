...
<html lang="en">
    ...
    <body> 
      ...
      <div id="div2" class="container">
        <h3><b><a href="../View/Homepage.php">Personal Contacts</b></h3>
        <br>
            <ul>
                <li><a href="./ContactsView/InsertContactsView.php" class="contacts">Add Contacts</a></li>
                <li class="contacts"><a href=".././Controller/ContactsController.php?Delete_show_all=true">Delete Contacts</a></li>
                <li class="contacts"><a href="../Controller/ContactsController.php?show_all=true">View Contacts</a></li>
            </ul>
            <br>
            <h4><a id="police" href="./PSView/ShowPSView.php"><b>Police Station Contacts</b></a></h4>
      </div> 
