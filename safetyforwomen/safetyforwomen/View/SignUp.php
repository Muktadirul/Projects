...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <div class="block">
            <form action="../Controller/InfoController.php" method="post" class="form-horizontal" role="form">
            ...
            <div class="form-group">
                <label class="control-label col-sm-5">Contact No. 1:</label>
                    <div class="col-sm-7">
            ...
            <div class="form-group">
                <label class="control-label col-sm-5">Contact No. 2:</label>
                    <div class="col-sm-7">
            ...
            <input type="submit" class="btn btn-danger btn-lg" id="btn" name="SignUp" value="Sign Up">
