...
<body>
    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h1 class="section-heading">Modify Students</h1>
       ...
       if ( mysql_num_rows($retval) > 0) {
                ...
                $X="http://localhost:8080/SIS/ModifySelectStudent.php?id=";
                echo "<td><a href=".$X.$row['student_id']."><button >Select</button></a></td>";
                echo '</tr>';
    }
} 
       ?>
