...
<body>
    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h1 class="section-heading">Remove Subjects</h1>
       ...
       if ( mysql_num_rows($retval) > 0) {
                ...
                $X="http://localhost:8080/SIS/DeleteSubjectBackEnd.php?id=";
                echo "<td><a href=".$X.$row['sub_id']."><button type='button' class='btn btn-danger' >Delete</button></a></td>";
                echo '</tr>';
    }
} 
       ?>
