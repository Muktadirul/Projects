        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <form  class="form-horizontal" method="post" action="CreateClassBackEnd.php">
                      <div class="form-group">
                        <label for="inputClass3" class="col-md-4 control-label">Class Name</label>
                        <div class="col-md-4">
                          <input type="text" name="Class_Name" class="form-control" id="inputClass3" placeholder="Class Name">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="inputSubject3" class="col-md-4 control-label" >Capasity</label>
                        <div class="col-md-4">
                          <input type="text" name="Capacity" class="form-control" id="inputSubject3" placeholder="Number of Subjects">
                        </div>
                      </div>
                      <div class="form-group">
