...
$id = $_GET['id'];
$sql = "SELECT * FROM `sis_teacher` where T_id=" . $_GET['id'];
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <form method="post" action="ModifyTeacherBackEnd.php?id=<?php echo $id; ?>">
                            ...
                            if (mysql_num_rows($retval) > 0) {
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="TN" value="<?php echo $row['T_name']; ?>"></td>
                                    <td><input type="text" name="TA" value="<?php echo $row['T_address']; ?>"></td>
                                    <td><input type="text" name="TQ" value="<?php echo $row['T_qualification']; ?>"></td>
