        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h1 class="section-heading">Add Subject</h1>
                    <p class="lead section-lead">Please enter Name of Class and Number of Subjects</p>

                    <form  class="form-horizontal" method="post" action="CreateSubjectBackEnd.php">
                      <div class="form-group">
                        <label for="inputClass3" class="col-md-4 control-label">Subject Name</label>
                        <div class="col-md-4">
                          <input type="text" name="SubjectName" class="form-control" id="inputClass3" placeholder="Subject Name">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="inputSubject3" class="col-md-4 control-label" >Resource Id</label>
                        <div class="col-md-4">
                                ...
                                <select name="r_id">
                                    ...
                                    if (mysql_num_rows($retval) > 0) {
                                        while ($row = mysql_fetch_array($retval)) {
                                            echo ' <option name="r_id" value="' . $row['r_id'] . '">' . $row['r_type'] . '</option>';
                                        }
                                    } else {
                                        echo "0 results";
                                    }
