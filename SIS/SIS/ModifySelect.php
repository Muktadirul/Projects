...
$id = $_GET['id'];
$sql = "SELECT * FROM `sis_class` where class_id=" . $_GET['id'];
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <form method="post" action="ModifyBackEnd.php?id=<?php echo $id; ?>">    
                            <table class="table table-hover">
                                ...
                                if (mysql_num_rows($retval) > 0) {
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="CN" value="<?php echo $row['class_name']; ?>"></td>
                                        <td><input type="text" name="CP" value="<?php echo $row['capacity'] ?>"></td>
