        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <form class="form-horizontal" method="post" action="CreateStudentBackEnd.php">

                      <div class="form-group">
                        <label for="inputSubject3" class="col-md-4 control-label">Name</label>
                        <div class="col-md-4">
                          <input name="Student_Name" type="text" class="form-control" id="inputSubject3" placeholder="Name">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4">
                          <input name="Student_Roll" type="text" class="form-control" id="inputSubject3" placeholder="Roll">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4">
                          <input name="Student_Contact" type="text" class="form-control" id="inputSubject3" placeholder="Contact">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4">
                          <input name="Student_Class" type="text" class="form-control" id="inputSubject3" placeholder="Class">
                        </div>
                      </div>
