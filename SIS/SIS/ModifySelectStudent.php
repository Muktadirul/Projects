...
$id=$_GET['id'];
$sql = "SELECT * FROM `sis_student` where student_id=".$_GET['id'];
...
<html lang="en">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <h1 class="section-heading">Modify Classes</h1>

                        <form  method="post" action="ModifyStudentBackEnd.php?id=<?php echo $id;?>">
    ...
    <tr>
        ...
        <td><input type="text" name="SN" value="<?php echo $row['student_name'];?>"></td>
        <td><input type="text" name="SC" value="<?php echo $row['class_id']?>"></td>
        <td><input type="text" name="SR" value="<?php echo $row['roll']?>"></td>
        <td><input type="text" name="SCON" value="<?php echo $row['contact']?>"></td>
